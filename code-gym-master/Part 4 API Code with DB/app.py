...
client = MongoClient("mongodb+srv://kedardeo:oit123#@cluster0.lptw9ax.mongodb.net/?retryWrites=true&w=majority&appName=AtlasApp") # Replace with your mongo altas connection url
